    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
                        ...
                        <div class="row gy-3">
                            <div class="col-md-3 col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="card-info">
                                        <h5 class="mb-0">{{ App\Models\Order::where('order_status', 4)->count() }}</h5>
                                        <small>Sales</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="card-info">
                                        <h5 class="mb-0">{{ App\Models\User::doesntHave('roles')->count() }}</h5>
                                        <small>العملاء</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="card-info">
                                        <h5 class="mb-0">{{ App\Models\Order::where('order_status', 0)->count() }}</h5>
                                        <small>الطلبات</small>
                                    </div>
                                </div>
                            </div>
            ...
            foreach ($top_sales as $s) {
                $p = App\Models\Product::findOrFail($s->id);
                $p->totalQty = $s->total;
                $top_products[] = $p;
                 //dd($top_products);
            }
                ...
                <div class="card h-100">
                    <div class="card-header d-flex justify-content-between">
                        <div class="card-title m-0 me-2">
                            <h5 class="m-0 me-2">المنتجات الاكثر مبيعا</h5>
                                ...
                                <li class="d-flex mb-4 pb-1">
                                    <div class="me-3">
                                        @if ($top_product->image)
                                            <img src="{{ asset('Files/images/products/' . $top_product->image) }}"
                                    ...
                                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                                            <h6 class="mb-0">{{ $top_product->name }}</h6>
                                            <small class="text-muted d-block">Item: #FXZ-4567</small>
                                        </div>
                                        <div class="user-progress d-flex align-items-center gap-1">
                                            <p class="mb-0 fw-medium">
                                                {{ $top_product->discount_price != null ? $top_product->discount_price : $top_product->main_price }}
                                                رس</p>
                                        </div>
                                    </div>
                                </li>
                ...
                <div class="card h-100">
                    <div class="card-header d-flex justify-content-between pb-2 mb-1">
                        <div class="card-title mb-1">
                            <h5 class="m-0 me-2">الطلبات</h5>
                            <small class="text-muted"> عمليات التسليم قيد التنفيد
                                -->{{ \App\Models\Order::where('order_status', 1)->count() }}</small>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="nav-align-top">
                            ...
                            <div class="tab-content pb-0">
                                <div class="tab-pane fade show active" id="navs-justified-new" role="tabpanel">
                                    <?php
                                    $pendings = App\Models\Order::with(['location', 'user'])
                                        ->where('order_status', 0)
                                        ->latest()
                                        ->get();
                                    $in_process = App\Models\Order::with(['location', 'user'])
                                        ->where('order_status', 1)
                                        ->latest()
                                        ->get();
                                    $complete = App\Models\Order::with(['location', 'user'])
                                            ...
                                            <li class="timeline-item ps-4 border-left-dashed">
                                                ...
                                                <div class="timeline-event ps-0 pb-0">
                                                    <div class="timeline-header">
                                                        <small class="text-success text-uppercase fw-medium">العميل</small>
                                                    </div>
                                                    <h6 class="mb-0">{{ $pending->user->full_name }}</h6>
                                                    <p class="text-muted mb-0 text-nowrap">
                                                        {{ $pending->location->address }}</p>
                                                </div>
                                            </li>
                                        ...
                                        <ul class="timeline timeline-advance mb-2 pb-1">
                                            <li class="timeline-item ps-4 border-left-dashed">
                                                ...
                                                <div class="timeline-event ps-0 pb-0">
                                                    ...
                                                    <h6 class="mb-0">{{ $pro->user->full_name }}</h6>
                                                    <p class="text-muted mb-0 text-nowrap">{{ $pro->location->address }}
                                                    </p>
                                                </div>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="timeline timeline-advance mb-2 pb-1">
                                            <li class="timeline-item ps-4 border-left-dashed">
                                                ...
                                                <div class="timeline-event ps-0 pb-0">
                                                    ...
                                                    <h6 class="mb-0">{{ $com->user->full_name }}</h6>
                                                    <p class="text-muted mb-0 text-nowrap">{{ $com->location->address }}
                                                    </p>
                                                </div>
                                            </li>
                                        </ul>
