...
@section('content')
    ...
    <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
        <div class="w-px-400 mx-auto">
            ...
            <!-- /Logo -->
            <h3 class="mb-1 fw-bold">مرحبا بعودتك! 👋</h3>
            <p class="mb-4">الرجاء تسجيل الدخول إلى حسابك </p>
            ...
            <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="email"
                        placeholder="ادخل بريدك الالكترونى" autofocus />
                    @error('email')
                ...
                <div class="mb-3">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="remember-me" {{ old('remember') ? 'checked' : '' }}>تذكرنى </label>
                    </div>
                </div>
                <button class="btn btn-primary d-grid w-100">تسجيل دخول</button>
            </form>
