        ...
        <div class="w-px-400 mx-auto">
            ...
            <form id="formAuthentication" class="mb-3" action="{{ route('password.update') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control  @error('email') is-invalid @enderror" id="email" name="email" placeholder="ادخل بريدك الالكترونى"
                ...
                <button class="btn btn-primary d-grid w-100 mb-3">حفظ</button>
